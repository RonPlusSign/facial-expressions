export class Tristezza {
  static data() {
    return {
      name: "Tristezza",
      view: "/views/tristezza.html",
      title: "Triste",
      briefDescription: "La tristezza è un sentimento di sofferenza.",
      description: `
      La tristezza è un sentimento di <b>sofferenza</b>.
      ...
      <br>
      Spesso nella tristezza <b>lo sguardo è abbassato</b>, soprattutto quando insieme alla tristezza si mescolano sentimenti quali vergogna o sensi di colpa.
      ...
      <br>
      Ad un certo livello di tristezza compariranno nell'emozione il <b>pianto</b> e il <b>tremito delle labbra</b>, oppure un viso completamente inespressivo visto che si ha la perdita di tono muscolare del volto.
      `,
      imageUrl: "/images/sad.jpg",
      buttonLink: "/views/tristezza.html",
      color: "#448aff"
    };
  }
}
